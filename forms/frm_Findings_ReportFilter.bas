            ...
            Begin
                Begin ComboBox
                    ...
                    RowSource ="SELECT DISTINCT tbl_AuditReports.AuditReportID, tbl_AuditReports.Audit_Report_Nu"
                        "mber FROM tbl_finding INNER JOIN (tbl_AuditReports INNER JOIN tbl_AuditEntries O"
                        "N tbl_AuditReports.AuditReportID = tbl_AuditEntries.AuditReportID) ON tbl_findin"
                        "g.EntryID = tbl_AuditEntries.EntryID; "
                    ColumnWidths ="0;1443"
                    GroupTable =1
                    BottomPadding =150
...
End
CodeBehindForm
' See "frm_Findings_ReportFilter.cls"
