...
Begin Report
    ...
    RecordSource ="SELECT tbl_AuditReports.AuditReportID, tbl_AuditReports.Audit_Report_Number, tbl"
        "_Regulations.Checklist_Definition, tbl_CAAC.*, tbl_Regulations.* FROM tbl_CAAC I"
        "NNER JOIN ((tbl_Checklists INNER JOIN tbl_AuditReports ON tbl_Checklists.[CL-100"
        "_No] = tbl_AuditReports.Audit_Checklists.Value) INNER JOIN tbl_Regulations ON tb"
        "l_Checklists.[CL-100_No] = tbl_Regulations.Checklist_No) ON tbl_CAAC.ID = tbl_Re"
        "gulations.CAAC_ID WHERE (((tbl_CAAC.CAAC_Definition) Is Not Null)); "
            ...
            Begin
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        End
                        Begin
                            Comment ="_AXL:e=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_CAAC_R"
                        ...
                        End
                        Begin
                            Comment ="_AXL:o</Argument><Argument Name=\"Subject\">[Audit_Report_Number] CAAC Rules Lis"
                    ...
                    LayoutCachedLeft =13549
                    LayoutCachedWidth =14089
                ...
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        End
                        Begin
                            Comment ="_AXL:tType\">Report</Argument><Argument Name=\"ObjectName\">rprt_EASA_Rules_List"
                    ...
                    LayoutCachedLeft =14209
                    LayoutCachedWidth =14689
                    LayoutCachedHeight =300
                    Overlaps =1
                End
            End
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="txt_CAAC_ID"
                    ControlSource ="=Nz(DLookUp(\"CAAC_ID\",\"tbl_CompletedRules\",\"RegulationID=\" & [txt_Regulati"
                        "onID] & \" AND AuditReportID=\" & [txt_ID]),DLookUp(\"CAAC_ID\",\"tbl_Regulation"
                        "s\",\"RegulationID=\" & [txt_RegulationID]))"
                    GroupTable =1
                    BottomPadding =150
