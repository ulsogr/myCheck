...
Begin Report
    ...
    RecSrcDt = Begin
        0x3b54c9cccb5de640
    End
    RecordSource ="SELECT tbl_Regulations.*, tbl_UKCAA.*, tbl_AuditEntries.*, tbl_AuditReports.Audi"
        "tor_Lead, tbl_AuditReports.Auditor_Asist, tbl_AuditReports.Audit_Report_Number, "
        "tbl_AuditReports.Audit_Report_Date, tbl_AuditReports.Remarks, tbl_AuditEntries.R"
        "ecord_Audit_Appear_Report, tbl_Regulations.isActive, tbl_AuditEntries.Results_Al"
        "l, tbl_AuditEntries.Results_UKCAA, tbl_AuditReports.Audit_Applicability, tbl_Aud"
        "itEntries.RegulationID AS Expr666, tbl_Checklists.[CL-100_Revision_Date], tbl_Au"
        "ditReports.Scheduled FROM tbl_Checklists INNER JOIN (tbl_UKCAA INNER JOIN ((tbl_"
        "AuditEntries INNER JOIN tbl_AuditReports ON tbl_AuditEntries.AuditReportID = tbl"
        "_AuditReports.AuditReportID) INNER JOIN tbl_Regulations ON tbl_AuditEntries.Regu"
        "lationID = tbl_Regulations.RegulationID) ON tbl_UKCAA.ID = tbl_Regulations.UK_CA"
        "A_ID) ON tbl_Checklists.[CL-100_No] = tbl_Regulations.Checklist_No WHERE (((tbl_"
        "Regulations.isActive)=Yes) And ((tbl_UKCAA.UK_CAA_Definition) Is Not Null) And ("
        "(tbl_UKCAA.UK_CAA_Part_Number) Is Not Null) And ((tbl_Regulations.Checklist_Appl"
        "icability.Value)=tbl_AuditReports.Audit_Applicability)); "
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:</Argument><Argument Name=\"Subject\">[Audit] Checklist [Audit_Report_Numbe"
                                "r]</Argument><Argument Name=\"MessageText\">Dear All, Please be informed that me"
                                "ntioned Checklist is attached. Best Regards,</Argument></Action></Statements></U"
                                "serInterfaceMacro"
                        End
                        Begin
                            Comment ="_AXL:>"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =10040879
                    Name ="Text601"
                    ControlSource ="=GetFilteredUKCAAAMCTextByRegulation([Expr666],[Audit_Applicability])"
                    Format ="@"
                    TextFormat =1
