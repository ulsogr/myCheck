...
Begin Report
    ...
    RecordSource ="SELECT tbl_AuditReports.AuditReportID, tbl_AuditReports.Audit_Report_Number, tbl"
        "_Regulations.Checklist_Definition, tbl_EASA.*, tbl_Regulations.*, tbl_EASA.Rule_"
        "Status, tbl_AuditReports.Scheduled FROM tbl_EASA INNER JOIN ((tbl_Checklists INN"
        "ER JOIN tbl_AuditReports ON tbl_Checklists.[CL-100_No] = tbl_AuditReports.Audit_"
        "Checklists.Value) INNER JOIN tbl_Regulations ON tbl_Checklists.[CL-100_No] = tbl"
        "_Regulations.Checklist_No) ON tbl_EASA.ID = tbl_Regulations.EASA_ID WHERE (((tbl"
        "_EASA.Rule_Status)=Yes) AND ((tbl_EASA.EASA_Definition) Is Not Null)); "
        ...
        Begin FormHeader
            ...
            Begin
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            ...
                            Argument =""
                            Argument ="[Audit_Report_Number] EASA Rules List"
                        ...
                        End
                        Begin
                            Comment ="_AXL:e=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_EASA_R"
                        ...
                        End
                        Begin
                            Comment ="_AXL:o</Argument><Argument Name=\"Subject\">[Audit_Report_Number] EASA Rules Lis"
                ...
                Begin CommandButton
                    ...
                    LayoutCachedLeft =13869
                    LayoutCachedTop =56
                    LayoutCachedWidth =14349
                    LayoutCachedHeight =356
                    Overlaps =1
                End
            End
