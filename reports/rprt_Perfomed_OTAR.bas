...
Begin Report
    ...
    ItemSuffix =981
    Filter ="[AuditReportID] = 7"
    RecSrcDt = Begin
        0x741fa7a2cc62e640
    End
    RecordSource ="SELECT tbl_Regulations.*, tbl_OTAR.*, tbl_AuditEntries.*, tbl_AuditReports.Audit"
        ...
        ", tbl_AuditEntries.Results_OTAR, tbl_AuditReports.Audit_Applicability, tbl_Audit"
        ...
        "NER JOIN (tbl_OTAR INNER JOIN ((tbl_AuditEntries INNER JOIN tbl_AuditReports ON "
        ...
        "tbl_OTAR.ID = tbl_Regulations.OTAR_ID) ON tbl_Checklists.[CL-100_No] = tbl_Regul"
        "ations.Checklist_No WHERE (((tbl_Regulations.isActive)=Yes) And ((tbl_OTAR.OTAR_"
        "Revision_Trace) Is Not Null) And ((tbl_Regulations.Checklist_Applicability.Value"
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:e=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_Perfom"
                                "ed_OTAR</Argument><Argument Name=\"OutputFormat\">PDFFormat(*.pdf)</Argument><Ar"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =10040879
                    Name ="Text601"
                    ControlSource ="=GetFilteredOTARAMCTextByRegulation([expr666],[Audit_Applicability])"
                    Format ="@"
                    TextFormat =1
                ...
                Begin TextBox
                    ...
                    ForeColor =10040879
                    Name ="txtResult_EASA"
                    ControlSource ="tbl_AuditEntries.Results_OTAR"
                    GroupTable =9
                    TextFormat =1
