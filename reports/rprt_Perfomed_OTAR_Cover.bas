...
Begin Report
    ...
    RecordSource ="SELECT tbl_AuditEntries.*, tbl_AuditReports.Auditor_Lead, tbl_AuditReports.Audit"
        ...
        "finition, tbl_OTAR.*, tbl_Regulations.[CL-100_Revision_Reason], tbl_finding.Appl"
        ...
        "NNER JOIN (tbl_OTAR INNER JOIN (tbl_finding INNER JOIN ((tbl_AuditEntries INNER "
        ...
        "OTAR.ID = tbl_Regulations.OTAR_ID) ON tbl_Checklists.[CL-100_No] = tbl_Regulatio"
        "ns.Checklist_No WHERE (((tbl_finding.Applicability.Value)=\"ALL\" Or (tbl_findin"
        "g.Applicability.Value)=\"OTAR\")); "
            ...
            Begin
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Action ="SendObject"
                            Argument ="3"
                            Argument ="rprt_Perfomed_OTAR_Cover"
                        ...
                        Begin
                            Comment ="_AXL:e=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_Perfom"
                                "ed_OTAR_Cover</Argument><Argument Name=\"OutputFormat\">PDFFormat(*.pdf)</Argume"
                ...
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        End
                        Begin
                            Comment ="_AXL:tType\">Report</Argument><Argument Name=\"ObjectName\">rprt_Perfomed_OTAR_C"
                ...
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            ...
                            Argument ="rprt_Perfomed_OTAR_Cover.xlsx"
                            Argument ="0"
                            Argument =""
                            Argument =""
                            Argument ="1"
                        ...
                        Begin
                            Comment ="_AXL:ame=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_Perf"
                                "omed_OTAR_Cover</Argument><Argument Name=\"OutputFormat\">ExcelWorkbook(*.xlsx)<"
                                "/Argument><Argument Name=\"OutputFile\">rprt_Perfomed_OTAR_Cover.xlsx</Argument>"
                                "<Argument Name=\"Outpu"
                        End
                        Begin
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =10040879
                    Name ="Text597"
                    ControlSource ="=Nz(DLookUp(\"OTAR_Part_Number\",\"tbl_OTAR\",\"ID=\" & [txt_OTAR_ID]),\"Additio"
...
End
CodeBehindForm
' See "rprt_Perfomed_OTAR_Cover.cls"
