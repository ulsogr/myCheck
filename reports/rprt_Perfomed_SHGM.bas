...
Begin Report
    ...
    RecSrcDt = Begin
        0x2fb7182acb5de640
    End
    RecordSource ="SELECT tbl_Regulations.*, tbl_SHGM.*, tbl_AuditEntries.*, tbl_AuditReports.Audit"
        ...
        ", tbl_AuditEntries.Results_SHGM, tbl_AuditReports.Audit_Applicability, tbl_Audit"
        ...
        "NER JOIN (tbl_SHGM INNER JOIN ((tbl_AuditEntries INNER JOIN tbl_AuditReports ON "
        ...
        "tbl_SHGM.ID = tbl_Regulations.SHGM_ID) ON tbl_Checklists.[CL-100_No] = tbl_Regul"
        "ations.Checklist_No WHERE (((tbl_Regulations.isActive)=Yes) And ((tbl_SHGM.SHGM_"
        "Definition) Is Not Null) And ((tbl_SHGM.SHGM_Part_Number) Is Not Null) And ((tbl"
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:e=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_Perfom"
                                "ed_SHGM</Argument><Argument Name=\"OutputFormat\">PDFFormat(*.pdf)</Argument><Ar"
        ...
        Begin PageHeader
            ...
            Begin
                ...
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Label917"
                    Caption ="SHGM Checklist "
                    LayoutCachedLeft =4326
                    LayoutCachedTop =56
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =10040879
                    Name ="Text601"
                    ControlSource ="=GetFilteredSHGMTextByRegulation([expr666],[Audit_Applicability])"
                    Format ="@"
                    TextFormat =1
                ...
                Begin TextBox
                    ...
                    ForeColor =10040879
                    Name ="txtResult_EASA"
                    ControlSource ="tbl_AuditEntries.Results_SHGM"
                    TextFormat =1
                ...
                Begin TextBox
                    ...
                    LayoutCachedLeft =2450
                    LayoutCachedTop =5523
                    LayoutCachedWidth =10886
                    LayoutCachedHeight =5751
                    RowStart =19
                    RowEnd =19
                    ColumnStart =1
                    ColumnEnd =3
