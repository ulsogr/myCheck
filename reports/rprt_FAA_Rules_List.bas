...
Begin Report
    ...
    RecordSource ="SELECT tbl_AuditReports.AuditReportID, tbl_AuditReports.Audit_Report_Number, tbl"
        "_Regulations.Checklist_Definition, tbl_FAA.*, tbl_Regulations.*, tbl_AuditReport"
        "s.Scheduled FROM tbl_FAA INNER JOIN ((tbl_Checklists INNER JOIN tbl_AuditReports"
        " ON tbl_Checklists.[CL-100_No] = tbl_AuditReports.Audit_Checklists.Value) INNER "
        "JOIN tbl_Regulations ON tbl_Checklists.[CL-100_No] = tbl_Regulations.Checklist_N"
        "o) ON tbl_FAA.ID = tbl_Regulations.FAA_ID WHERE (((tbl_FAA.FAA_Definition) Is No"
        "t Null)); "
            ...
            Begin
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        End
                        Begin
                            Comment ="_AXL:e=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_FAA_Ru"
                                "les_List</Argument><Argument Name=\"OutputFormat\">PDFFormat(*.pdf)</Argument><A"
                                "rgument Name=\"To\">qm.audit@mytechnic.aero</Argument><Argument Name=\"Cc\">Arzu"
                                ".ertekin@mytechnic.aero"
                        End
                        Begin
                            Comment ="_AXL:</Argument><Argument Name=\"Subject\">[Audit_Report_Number] FAA Rules List<"
                                "/Argument><Argument Name=\"MessageText\">Dear All, Please be informed that menti"
                                "oned Checklist is attached. Best Regards,</Argument></Action></Statements></User"
                                "InterfaceMacro>"
                        End
                    End
                    ImageData = Begin
                ...
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        End
                        Begin
                            Comment ="_AXL:tType\">Report</Argument><Argument Name=\"ObjectName\">rprt_FAA_Rules_List<"
                    ...
                    LayoutCachedLeft =13982
                    LayoutCachedTop =56
                    LayoutCachedWidth =14462
                    LayoutCachedHeight =356
                    Overlaps =1
                End
            End
