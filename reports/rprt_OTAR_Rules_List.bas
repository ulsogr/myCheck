...
Begin Report
    ...
    RecordSource ="SELECT tbl_AuditReports.AuditReportID, tbl_AuditReports.Audit_Report_Number, tbl"
        "_Regulations.Checklist_Definition, tbl_OTAR.*, tbl_Regulations.*, tbl_AuditRepor"
        "ts.Scheduled FROM tbl_OTAR INNER JOIN ((tbl_Checklists INNER JOIN tbl_AuditRepor"
        ...
        "_No) ON tbl_OTAR.ID = tbl_Regulations.OTAR_ID WHERE (((tbl_OTAR.OTAR_Definition)"
        " Is Not Null)); "
            ...
            Begin
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        End
                        Begin
                            Comment ="_AXL:e=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_OTAR_R"
                        ...
                        End
                        Begin
                            Comment ="_AXL:o</Argument><Argument Name=\"Subject\">[Audit_Report_Number] OTAR Rules Lis"
                ...
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        End
                        Begin
                            Comment ="_AXL:tType\">Report</Argument><Argument Name=\"ObjectName\">rprt_OTAR_Rules_List"
                    ...
                    LayoutCachedLeft =14039
                    LayoutCachedWidth =14519
                    LayoutCachedHeight =300
                    Overlaps =1
                End
            End
