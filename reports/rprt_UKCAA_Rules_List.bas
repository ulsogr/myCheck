...
Begin Report
    ...
    RecordSource ="SELECT tbl_AuditReports.AuditReportID, tbl_AuditReports.Audit_Report_Number, tbl"
        "_Regulations.Checklist_Definition, tbl_UKCAA.*, tbl_Regulations.*, tbl_AuditRepo"
        "rts.Scheduled FROM tbl_UKCAA INNER JOIN ((tbl_Checklists INNER JOIN tbl_AuditRep"
        "orts ON tbl_Checklists.[CL-100_No] = tbl_AuditReports.Audit_Checklists.Value) IN"
        "NER JOIN tbl_Regulations ON tbl_Checklists.[CL-100_No] = tbl_Regulations.Checkli"
        "st_No) ON tbl_UKCAA.ID = tbl_Regulations.UK_CAA_ID WHERE (((tbl_UKCAA.UK_CAA_Def"
        "inition) Is Not Null)); "
            ...
            Begin
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        End
                        Begin
                            Comment ="_AXL:e=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_UKCAA_"
                                "Rules_List</Argument><Argument Name=\"OutputFormat\">PDFFormat(*.pdf)</Argument>"
                                "<Argument Name=\"To\">qm.audit@mytechnic.aero</Argument><Argument Name=\"Cc\">Ar"
                                "zu.ertekin@mytechnic.ae"
                        End
                        Begin
                            Comment ="_AXL:ro</Argument><Argument Name=\"Subject\">[Audit_Report_Number] UK CAA Rules "
                                "List</Argument><Argument Name=\"MessageText\">Dear All, Please be informed that "
                                "mentioned Checklist is attached. Best Regards,</Argument></Action></Statements><"
                                "/UserInterfaceMac"
                        End
                        Begin
                            Comment ="_AXL:ro>"
                ...
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        End
                        Begin
                            Comment ="_AXL:tType\">Report</Argument><Argument Name=\"ObjectName\">rprt_UKCAA_Rules_Lis"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =3
                    Name ="txt_UK_CAA_ID"
                    ControlSource ="=GetEffectiveRuleIDByCondition([txt_RegulationID],[txt_ID],[tbl_AuditReports.Sch"
                        "eduled],\"tbl_UKCAA\",\"UK_CAA_ID\")"
                    GroupTable =1
                    BottomPadding =150
