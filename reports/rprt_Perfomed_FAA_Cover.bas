...
Begin Report
    ...
    RecordSource ="SELECT tbl_AuditEntries.*, tbl_AuditReports.Auditor_Lead, tbl_AuditReports.Audit"
        "_Report_Number, tbl_AuditReports.Audit_Report_Date, tbl_finding.*, tbl_Regulatio"
        "ns.Checklist_Definition, tbl_FAA.*, tbl_Regulations.[CL-100_Revision_Reason], tb"
        "l_finding.Applicability.Value, tbl_AuditReports.Auditor_Asist, tbl_AuditReports."
        "Group, tbl_AuditReports.Record_year, tbl_AuditReports.Audit_Checklists, tbl_Chec"
        "klists.[CL-100_Revision_Date], tbl_AuditReports.Scheduled FROM tbl_Checklists IN"
        "NER JOIN (tbl_FAA INNER JOIN (tbl_finding INNER JOIN ((tbl_AuditEntries INNER JO"
        "IN tbl_AuditReports ON tbl_AuditEntries.AuditReportID = tbl_AuditReports.AuditRe"
        "portID) INNER JOIN tbl_Regulations ON tbl_AuditEntries.RegulationID = tbl_Regula"
        "tions.RegulationID) ON tbl_finding.EntryID = tbl_AuditEntries.EntryID) ON tbl_FA"
        "A.ID = tbl_Regulations.FAA_ID) ON tbl_Checklists.[CL-100_No] = tbl_Regulations.C"
        "hecklist_No WHERE (((tbl_finding.Applicability.Value)=\"ALL\" Or (tbl_finding.Ap"
        "plicability.Value)=\"FAA\")); "
            ...
            Begin
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Action ="SendObject"
                            Argument ="3"
                            Argument ="rprt_Perfomed_FAA_Cover"
                        ...
                        Begin
                            Comment ="_AXL:e=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_Perfom"
                                "ed_FAA_Cover</Argument><Argument Name=\"OutputFormat\">PDFFormat(*.pdf)</Argumen"
                                "t><Argument Name=\"To\">qm.audit@mytechnic.aero</Argument><Argument Name=\"Cc\">"
                                "Arzu.ertekin@mytechnic."
                        End
                        Begin
                            Comment ="_AXL:aero</Argument><Argument Name=\"Subject\">[Audit] Checklist [Audit_Report_N"
                                "umber]</Argument><Argument Name=\"MessageText\">Dear All, Please be informed tha"
                                "t mentioned Checklist is attached. Best Regards,</Argument></Action></Statements"
                                "></UserInterfaceM"
                        End
                        Begin
                            Comment ="_AXL:acro>"
                ...
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        End
                        Begin
                            Comment ="_AXL:tType\">Report</Argument><Argument Name=\"ObjectName\">rprt_Perfomed_FAA_Co"
                                "ver</Argument></Action></Statements></UserInterfaceMacro>"
                        End
                    End
                    ImageData = Begin
                        0x2800000010000000100000000100200000000000000000000000000000000000 ,
                ...
                Begin Label
                    ...
                    ForeColor =6108695
                    Name ="Label930"
                    Caption ="FAA Checklist Report "
                    LayoutCachedLeft =3766
                    LayoutCachedTop =397
                    LayoutCachedWidth =7234
                ...
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            ...
                            Argument ="rprt_Perfomed_FAA_Cover.xlsx"
                            Argument ="0"
                            Argument =""
                            Argument =""
                            Argument ="1"
                        ...
                        Begin
                            Comment ="_AXL:ame=\"ObjectType\">Report</Argument><Argument Name=\"ObjectName\">rprt_Perf"
                                "omed_FAA_Cover</Argument><Argument Name=\"OutputFormat\">ExcelWorkbook(*.xlsx)</"
                                "Argument><Argument Name=\"OutputFile\">rprt_Perfomed_FAA_Cover.xlsx</Argument><A"
                                "rgument Name=\"OutputQ"
                        End
                        Begin
                            Comment ="_AXL:uality\">Screen</Argument></Action></Statements></UserInterfaceMacro>"
                        End
                    End
                    ImageData = Begin
                        0x2800000010000000100000000100200000000000000000000000000000000000 ,
                    ...
                    LayoutCachedLeft =8566
                    LayoutCachedWidth =9106
                    LayoutCachedHeight =300
                    Overlaps =1
                End
                Begin TextBox
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =10040879
                    Name ="Text597"
                    ControlSource ="=Nz(DLookUp(\"FAA_Part_Number\",\"tbl_FAA\",\"ID=\" & [txt_FAA_ID]),\"Additional"
                        " Items to be Checked\")"
                    GroupTable =5
                    TextFormat =1
...
End
CodeBehindForm
' See "rprt_Perfomed_FAA_Cover.cls"
